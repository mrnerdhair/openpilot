  ...
  def update(self, CC, CS, now_nanos):
    ...
    if CS.button_counter != self.last_button_frame:
      ...
      if ram_cars:
        ...
        elif CS.buttonStates["resumeCruise"]:
          can_sends.append(create_cruise_buttons(self.packer, CS.button_counter, das_bus, self.CP, resume=True))
        elif any(CS.buttonStates[button_state] for button_state in ["accelCruise", "decelCruise"]):
